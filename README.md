...
-**CRUD Completo** - Implementação completa das operações de Create, Read, Update, e Delete.
 ...
 Contexto:
 O gameflix é uma plataforma de streaming de jogos que virou ebre entre os jovens.
 Com o sucesso, eles precisam atualizar constantemente  seu banco de dados.
